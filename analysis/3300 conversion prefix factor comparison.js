"use strict";
/**
 * check, if there are contradictions in an ontology between 
 * conversion and prefix values
 */
...
// local settings
var localCfg = {
      moduleName: 'checkPrefixConversion',
      moduleKey:  '3300'
    },
...
function checkPrefixConversion() {
...
if(require.main === module) {
  checkPrefixConversion().done(); 
} else { 
  module.exports = checkPrefixConversion; 
}