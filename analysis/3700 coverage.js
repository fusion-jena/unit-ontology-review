 ...
 *          
 * output:
 * - coverage           ... counts how many instances of the baseType have at least one entry in the relation
 * - coverage_missing   ... URIs of the baseType with no entry in the relation
 */
...
function coverage() {
  ...
  OntoStore.storeResult( localCfg.moduleKey, localCfg.moduleName + '_missing', missing );
